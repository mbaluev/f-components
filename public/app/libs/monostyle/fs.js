/**
 * Created by mbaluev at 2019.08.19
 */
...
(function ($) {
	var methods = {
		activate: function () {
			return this.each(function () {
				$(this).find('[data-toggle="f-popup"]').addBack('[data-toggle="f-popup"]').on('click mouseover', function (e) {
					...
					that.render = function () {
						$('body').append(
							that.data._popup.popup.empty().append(
								...
								$(self.data('target')).clone(true, true).removeClass('f-menu_popup_hidden')
							)
						);
						that.bind_popup();
					};
...
(function ($) {
	var methods = {
		activate: function () {
			return this.each(function () {
				$(this).find('[data-toggle="f-search"]').addBack('[data-toggle="f-search"]').on('click', function (e, data) {
	...
	var methods = {
		activate: function () {
			return this.each(function () {
				...
				$('body').on('mouseover', '[data-tooltip], [title]', function (e) {
